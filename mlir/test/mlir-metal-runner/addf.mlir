// RUN: mlir-metal-runner %s --shared-libs=%metal_wrapper_library_dir/libmetal-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s
